<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="作品集简介" prop="zuopinjijianjie">
          <el-input v-model="ruleForm.zuopinjijianjie" 
              placeholder="作品集简介" clearable  :readonly="ro.zuopinjijianjie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="作品集简介" prop="zuopinjijianjie">
              <el-input v-model="ruleForm.zuopinjijianjie" 
                placeholder="作品集简介" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="作者名称" prop="zuozhemingcheng">
          <el-input v-model="ruleForm.zuozhemingcheng" 
              placeholder="作者名称" clearable  :readonly="ro.zuozhemingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="作者名称" prop="zuozhemingcheng">
              <el-input v-model="ruleForm.zuozhemingcheng" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="作者简介" prop="zuozhejianjie">
          <el-input v-model="ruleForm.zuozhejianjie" 
              placeholder="作者简介" clearable  :readonly="ro.zuozhejianjie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="作者简介" prop="zuozhejianjie">
              <el-input v-model="ruleForm.zuozhejianjie" 
                placeholder="作者简介" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `wodefenxiang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.wodefenxiangCrossAddOrUpdateFlag = false;
                  this.parent.search();
