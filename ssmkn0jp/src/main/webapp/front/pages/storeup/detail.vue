<template>
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback" :bottom="100">
		<view class="container">
					...
					<view class="lable" :style='{"width":"140rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>收藏id：</view>
					<view class="text" :style='{"color":"#333","textAlign":"right","fontSize":"28rpx"}'>{{detail.refid}}</view>
				</view>
                				                				<view class="detail-list-item" :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","margin":"0 0 2rpx 0","borderColor":"#fff","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid","height":"68rpx"}'>
					<view class="lable" :style='{"width":"140rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>表名：</view>
					<view class="text" :style='{"color":"#333","textAlign":"right","fontSize":"28rpx"}'>{{detail.tablename}}</view>
				</view>
                				                				<view class="detail-list-item" :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","margin":"0 0 2rpx 0","borderColor":"#fff","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid","height":"68rpx"}'>
					<view class="lable" :style='{"width":"140rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>收藏名称：</view>
