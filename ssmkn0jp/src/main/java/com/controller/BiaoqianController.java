...
public class BiaoqianController {
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,BiaoqianEntity biaoqian, HttpServletRequest request){
        EntityWrapper<BiaoqianEntity> ew = new EntityWrapper<BiaoqianEntity>();
		PageUtils page = biaoqianService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, biaoqian), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<BiaoqianEntity> wrapper = new EntityWrapper<BiaoqianEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = biaoqianService.selectCount(wrapper);
